...
const ShopPage = () => {
    return (
        <div>
            <div className="w-fit h-[92px] pt-[24px] pb-[24px] text-white ">
                <div className="w-[1049px] h-[44px] gap-[850px] flex flex-row ">
                    <div className="w-[510px] h-[32px] ml-[190px] ">
                        <h2 className="w-[62px] h-[32px] font-montserrat font-bold text-2xl	tracking-[0.1px] text-[#252B42] ">Shop</h2>
                    </div>
                    <div className="w-[509px] h-[44px] gap-[5px] mr-">
                        <div className="w-[119px] h-[44px] pt-[10px] pb-[10px] gap-[15px] flex flex-row ">
                            <p className="font-montserrat font-bold w-[43px] h-[24px] text-base tracking-[0.2px] text-[#252B42]">Home</p>
                            <ChevronRight className="w-[43px] h-[16px] text-[#BDBDBD]" />
                            <h6 className="w-[37px] h-[24px] font-montserrat font-bold text-base tracking-[0.2px] text-[#BDBDBD]">Shop</h6>
                        </div>
                    </div>
                </div>
            </div>

            <div className="w-fit h-[271px] bg-[#FAFAFA]">
                <div className="w-[1088px] h-[271px] ml-[176px] pb-[48px]">
                    <div className="w-[1088px] h-[223px] gap-[15px] flex flex-row">
                        <div className="w-[205px] h-[223px] bg-a1 bg-cover bg-center relative flex flex-col gap-2 saturate-10">
                            <div className="absolute inset-0 bg-black/25 z-0" />
                            <h6 className="w-[67px] h-[24px] mt-[87px] ml-[70px] text-[#FFFFFF] font-montserrat font-bold text-base tracking-[0.1px]">CLOTHS</h6>
                            <h6 className="w-[54px] h-[20px] top-[120.5px] ml-[76.5px] text-[#FFFFFF] font-montserrat font-normal text-sm tracking-[0.2px]">5 Items</h6>
                        </div>
                        <div className="w-[205px] h-[223px] bg-carousel bg-cover bg-center relative flex flex-col saturate-10">
                            <div className="absolute inset-0 bg-black/25 z-0" />
                            <h6 className="w-[67px] h-[24px] mt-[87px] ml-[70px] text-[#FFFFFF] font-montserrat font-bold text-base tracking-[0.1px]">CLOTHS</h6>
                            <h6 className="w-[54px] h-[20px] mt-[8.5px] ml-[76.5px] text-[#FFFFFF] font-montserrat font-normal text-sm tracking-[0.2px]">5 Items</h6>
                        </div>
                        <div className="w-[205px] h-[223px] bg-a3 bg-cover bg-center relative">
                            <div className="absolute inset-0 bg-black/25 z-0" />
                            <h6 className="w-[67px] h-[24px] mt-[87px] ml-[70px] text-[#FFFFFF] font-montserrat font-bold text-base tracking-[0.1px]">CLOTHS</h6>
                            <h6 className="w-[54px] h-[20px] mt-[8.5px] ml-[76.5px] text-[#FFFFFF] font-montserrat font-normal text-sm tracking-[0.2px]">5 Items</h6>
                        </div>
                        <div className="w-[205px] h-[223px] bg-a4 bg-cover bg-center relative">
                            <div className="absolute inset-0 bg-black/25 z-0" />
                            <h6 className="w-[67px] h-[24px] mt-[87px] ml-[70px] text-[#FFFFFF] font-montserrat font-bold text-base tracking-[0.1px]">CLOTHS</h6>
                            <h6 className="w-[54px] h-[20px] mt-[8.5px] ml-[76.5px] text-[#FFFFFF] font-montserrat font-normal text-sm tracking-[0.2px]">5 Items</h6>

                        </div>
                        <div className="w-[205px] h-[223px] bg-a5 bg-cover bg-center relative">
                            <div className="absolute inset-0 bg-black/25 z-0" />
                            <h6 className="w-[67px] h-[24px] mt-[87px] ml-[70px] text-[#FFFFFF] font-montserrat font-bold text-base tracking-[0.1px]">CLOTHS</h6>
                            <h6 className="w-[54px] h-[20px] mt-[8.5px] ml-[76.5px] text-[#FFFFFF] font-montserrat font-normal text-sm tracking-[0.2px]">5 Items</h6>
            ...
            <div className="w-full h-[98px] bg-[#FFFFFF]">
                <div className="flex flex-row w-[1050px] h-[98px] ml-[195px] mt-[24px] mb-[24px] gap-[80px] justify-between">
                    <div className="w-[168px] h-[24px] pr-[1px] pl-[1px] gap-[15px]">
                        <h6 className="w-[166px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373]">Showing all 12 results</h6>
                    </div>
                    <div className="w-[177px] h-[46px] pr-[1px] pl-[1px] gap-[15px] flex flew-row">
                        <h6 className="w-[53px] h-[24px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#737373]">Views:</h6>
                        <div className="w-[107px] h-[46px] gap-[15px] -mt-3 flex flex-row">
                            <button className="w-[46px] h-[46px] rounded-[5px] border-[1px] p-[15px] border-[#ECECEC] flex">
                                <LayoutGrid className="w-[16px] h-[16px] fill-[#252B42]" />
                            </button>

                            <button className="w-[46px] h-[46px] rounded-[5px] border-[1px] p-[15px] border-[#ECECEC] flex">
                                <Menu className="w-[16px] h-[16px] fill-[#252B42]" />
                            </button>
                        </div>
                    </div>
                    <div className="w-[251px] h-[50px] pr-[1px] pl-[1px] gap-[15px] flex flex-row">
                        <form className="w-[141px] h-[50px] border-[5px] border-none">
                            <label htmlFor="underline_select" className="sr-only">Underline select</label>
                            <select id="underline_select" className="block py-2.5 px-0 w-full text-sm text-[#737373] bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                <option value="default">
                                    Popularity <ChevronDown className="fill-black w-[10px] h-[16px]" />
                                </option>
                                <option value="L5">List Entry #5</option>
                                <option value="L4">List Entry #4</option>
                                <option value="L3">List Entry #3</option>
                                <option value="L2">List Entry #2</option>
                                <option value="L1">List Entry #1</option>
                            </select>

                            <button></button>
                        </form>
                        <ChevronDown className="pointer-events-none absolute right-2 top-1/2 transform -translate-y-1/2 w-4 h-4 color-[#737373] mt-[905px] mr-[370px]" />
                        <button className="w-[94px] h-[50px] pr-[20px] pl-[20px] pt-[10px] pb-[10px] border-[5px] gap-[10px] bg-[#23A6F0] border-none font-montserrat text-white font-bold">Filter</button>
                    </div>
                </div>
            </div>

            <div className="w-full h-[1778px] bg-[#FFFFFF] flex pl-[40px] ">
                <div className="w-[1124px] h-[1778px] ml-[158px] pt-[48px] pb-[48px] gap-[48px] flex flex-col">
                    <div className="w-[1048px] h-[488px] gap-[30px] flex">
                        <div className="w-[238px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-cover1 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>

                                <div className="w-[129.06px] h-[34px] pt-[5px] pb-[5px] pl-[3px] pr-[3px] gap-[5px] flex flex-row">
                                    <h5 className="w-[52px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#BDBDBD] pl-4">$16.48</h5>
                                    <h5 className="w-[66.06px] h-[24px] font-montserrat font-bold text-base	tracking-[0.1px] text-[#23856D] pl-5">$6.48</h5>
                                </div>
                        ...
                        <div className="w-[241px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-cover2 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="w-[239px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-new bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-cover4 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                    ...
                    <div className="w-[1048px] h-[488px] gap-[30px] flex flex-row">
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-a7 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-a8 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-a9 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-a10 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                    ...
                    <div className="w-[1048px] h-[488px] gap-[30px] flex flex-row">
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-s bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-s2 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-s3 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="w-[240px] h-[488px] bg-[#FFFFFF]">
                            <div className="w-[239px] h-[300px] bg-s4 bg-no-repeat bg-cover"></div>
                            <div className="w-[239px] h-[188px] pt-[25px] pr-[25px] pb-[35px] pl-[25px] gap-[10px] flex flex-col">
                                <h5 className="w-[170px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42] pl-4 flex">Graphic Design</h5>
                                <p className="w-[165px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373] pl-2">English Department</p>
                        ...
                        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-center">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className="size-5 text-[#BDBDBD] w-[70px] font-montserrat font-bold">
                                        Previous
                                    </p>
                                </a>
                                <a
                                    href="#"
                                    aria-current="page"
                                    className="relative z-10 inline-flex items-center bg-main-blue px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                >
                                    1
                                </a>
                                <a
                                ...
                                >
                                    ...
                                    <p className="size-5 text-main-blue font-montserrat font-bold w-[40px]">
                                        Next
                                    </p>
                                </a>
                            </nav>
            ...
            <div className="w-full h-[175px] bg-[#FAFAFA] flex flex-row">
                <div className="w-[1050px] h-[175px] ml-[195px] pt-[50px] pb-[50px] gap-[30px] flex justify-between">
                    <div className="w-[103px] h-[34px] mt-6">
