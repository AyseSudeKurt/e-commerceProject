...
import { Circle, Heart, ShoppingCart, Eye, ChevronRight } from 'lucide-react';
...
const ProductDetailPage = () => {
    return (
        <div>
                ...
                <div className='w-[1050px] h-[598px] ml-[195px] pb-[48px]'>
                    <div className='w-[1050px] h-[550px] gap-[30px] flex flex-row'>
                        ...
                        <div className='w-[510px] h-[471px] flex flex-col'>
                            ...
                            <div className='w-[298px] h-[44px] mt-[30px] ml-[24px] gap-[10px] flex'>
                                <div className='w-[148px] h-[44px] rounded-[5px] pt-[10px] pr-[20px] pb-[10px] pl-[10px] bg-main-blue flex border-none justify-center'>
                                    <h6 className='text-white font-montserrat font-bold w-[120px] h-[24px] text-sm tracking-[0.2px] flex mt-1 ml-1'>Select Options</h6>
                                </div>

                                <div className='w-[40px] h-[40px] rounded-[44.79px] border-[1px] bg-[#FFFFFF] border-[#E8E8E8]'>
                                    <Heart className="w-[20px] h-[20px] mt-[10px] ml-[10px] color-[#252B42]" />
                                </div>

                                <div className='w-[40px] h-[40px] rounded-[44.79px] border-[1px] bg-[#FFFFFF] border-[#E8E8E8]'>
                                    <ShoppingCart className="w-[20px] h-[20px] mt-[10px] ml-[10px] color-[#252B42]" />
                                </div>

                                <div className='w-[40px] h-[40px] rounded-[44.79px] border-[1px] bg-[#FFFFFF] border-[#E8E8E8]'>
                                    <Eye className="w-[20px] h-[20px] mt-[10px] ml-[9px] color-[#000000]" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className='w-full h-[572px] bg-[#FFFFFF] flex flex-col items-center'>
                <ul className='w-full h-[72px] flex flex-row justify-center items-center gap-8'>
                    <li className='w-[134px] h-[72px] flex items-center justify-center'>
                        <a className='font-montserrat font-semibold text-sm tracking-[0.2px] text-[#737373]'>
                            Description
                        </a>
                    </li>

                    <li className='w-[220px] h-[72px] flex items-center justify-center'>
                        <a className='font-montserrat font-bold text-sm tracking-[0.2px] text-[#737373]'>
                            Additional Information
                        </a>
                    </li>

                    <li className='w-[138px] h-[72px] flex items-center justify-center gap-1'>
                        <a className='font-montserrat font-bold text-sm tracking-[0.2px] text-[#737373]'>
                            Reviews
                        </a>
                        <a className='font-montserrat font-bold text-sm tracking-[0.2px] text-[#23856D]'>
                            (0)
                        </a>
                    </li>
                </ul>
                ...
                <div className='w-full h-[499px] gap-[50px]'>
                    <hr className='w-[1049px] h-px bg-[#ECECEC] border-none mt-2 mx-auto' />

                    <div className='w-full h-[499px] pt-[24px] pb-[48px] flex justify-center gap-[30px]'>

                        <div className='w-[332px] h-[392px] bg-new2 bg-cover bg-center flex flex-col'></div>


                        <div className='w-[332px] h-[427px] flex flex-col'>
                            <h5 className='w-[320px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#252B42]'>the quick fox jumps over </h5>
                            <br></br>
                            <h6 className='w-[332px] h-[340px] font-montserrat font-normal text-sm tracking-[0.2px] text-[#737373]'>Met minim Mollie non desert Alamo est sit cliquey dolor do met sent. RELIT official consequent door ENIM RELIT Mollie. Excitation venial consequent sent nostrum met.<br></br><br></br>

                                Met minim Mollie non desert Alamo est sit cliquey dolor do met sent. RELIT official consequent door ENIM RELIT Mollie. Excitation venial consequent sent nostrum met.<br></br><br></br>
                        ...
                        <div className='w-[332px] h-[367px] flex flex-col'>
                            <div className='w-[332px] h-[188px] border-[9px] border-none gap-[30px]'>
                                <h5 className='w-[324px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#252B42]'>the quick fox jumps over </h5>
                                <br></br>
                                <ul className='flex flex-col w-[304px] h-[126px] gap-[10px]'>
                                    <li className='w-[323px] h-[24px] gap-[20px] flex text-nowrap'>
                                        <ChevronRight className='w-[20px] h-[20px] color-[#737373]' />
                                        <h5 className='w-[274px] h-[24px] font-montserrat font-bold text-sm	tracking-[0.2px] text-[#737373]'>the quick fox jumps over the lazy dog</h5>
                                    </li>
                            ...
                            <div className='w-[332px] h-[188px] border-[9px] border-none gap-[30px] pt-[25px]'>
                                <h5 className='w-[324px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#252B42]'>the quick fox jumps over </h5>
                                <br></br>
                                <ul className='flex flex-col w-[304px] h-[126px] gap-[10px]'>
                                    <li className='w-[323px] h-[24px] gap-[20px] flex text-nowrap'>
            ...
            <div className='w-full h-[1086px] bg-[#FAFAFA]'>
                ...
                <div className='w-[1124px] h-[1086px] ml-[225px] pt-[48px] pb-[48px] gap-[24px]'>
                    <div className='w-[1040px] h-[32px]'>

                        <div className='w-[691px] h-[32px] gap-[10px]'>
                            <h3 className='w-[399px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#252B42]'>BESTSELLER PRODUCTS</h3>
                        </div>

                        <hr className='w-[1049px] h-px bg-[#ECECEC] border-none mt-2 mx-auto' />
                    </div>

                    <div className='w-[1049px] h-[442px] gap-[30px] flex flex-row mt-6'>
                        <div className='w-[238px] h-[442px] bg-[#FFFFFF]'>
                            <div className='w-[239px] h-[280px] bg-b1 bg-center bg-cover'></div>
                            <div className='w-[239px] h-[162px] pt-[25px] pb-[25px] pl-[25px] pr-[25px] gap-[10px] flex flex-col'>
                                <h5 className='w-[131px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42]'>Graphic Design</h5>
                                <p className='w-[190px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373]'>English Department</p>
                                <div className='w-[108px] h-[34px] pt-[5px] pb-[5px] pr-[3px] pl-[3px] gap-[3px] flex flex-row'>
                                    <h5 className='w-[52px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#BDBDBD]'>$16.48</h5>
                                    <h5 className='w-[45px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#23856D]'>$6.48</h5>
                                </div>
                            </div>
                        </div>

                        <div className='w-[241px] h-[442px] bg-[#FFFFFF]'>
                            <div className='w-[239px] h-[280px] bg-b2 bg-center bg-cover'></div>
                            <div className='w-[239px] h-[162px] pt-[25px] pb-[25px] pl-[25px] pr-[25px] gap-[10px] flex flex-col'>
                                <h5 className='w-[131px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42]'>Graphic Design</h5>
                                <p className='w-[190px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373]'>English Department</p>
                                <div className='w-[108px] h-[34px] pt-[5px] pb-[5px] pr-[3px] pl-[3px] gap-[3px] flex flex-row'>
                        ...
                        <div className='w-[240px] h-[442px] bg-[#FFFFFF]'>
                            <div className='w-[239px] h-[280px] bg-s4 bg-center bg-cover'></div>
                            <div className='w-[239px] h-[162px] pt-[25px] pb-[25px] pl-[25px] pr-[25px] gap-[10px] flex flex-col'>
                                <h5 className='w-[131px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42]'>Graphic Design</h5>
                                <p className='w-[190px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373]'>English Department</p>
                                <div className='w-[108px] h-[34px] pt-[5px] pb-[5px] pr-[3px] pl-[3px] gap-[3px] flex flex-row'>
                        ...
                        <div className='w-[240px] h-[442px] bg-[#FFFFFF]'>
                            <div className='w-[239px] h-[280px] bg-b8 bg-center bg-cover'></div>
                            <div className='w-[239px] h-[162px] pt-[25px] pb-[25px] pl-[25px] pr-[25px] gap-[10px] flex flex-col'>
                                <h5 className='w-[131px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42]'>Graphic Design</h5>
                                <p className='w-[190px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373]'>English Department</p>
                                <div className='w-[108px] h-[34px] pt-[5px] pb-[5px] pr-[3px] pl-[3px] gap-[3px] flex flex-row'>
                    ...
                    <div className='w-[1049px] h-[442px] gap-[30px] flex flex-row mt-6'>
                        <div className='w-[238px] h-[442px] bg-[#FFFFFF]'>
                            <div className='w-[239px] h-[280px] bg-a7 bg-center bg-cover'></div>
                            <div className='w-[239px] h-[162px] pt-[25px] pb-[25px] pl-[25px] pr-[25px] gap-[10px] flex flex-col'>
                                <h5 className='w-[131px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42]'>Graphic Design</h5>
                                <p className='w-[190px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373]'>English Department</p>
                                <div className='w-[108px] h-[34px] pt-[5px] pb-[5px] pr-[3px] pl-[3px] gap-[3px] flex flex-row'>
                        ...
                        <div className='w-[241px] h-[442px] bg-[#FFFFFF]'>
                            <div className='w-[239px] h-[280px] bg-b7 bg-center bg-cover'></div>
                            <div className='w-[239px] h-[162px] pt-[25px] pb-[25px] pl-[25px] pr-[25px] gap-[10px] flex flex-col'>
                                <h5 className='w-[131px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42]'>Graphic Design</h5>
                                <p className='w-[190px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373]'>English Department</p>
                                <div className='w-[108px] h-[34px] pt-[5px] pb-[5px] pr-[3px] pl-[3px] gap-[3px] flex flex-row'>
                        ...
                        <div className='w-[240px] h-[442px] bg-[#FFFFFF]'>
                            <div className='w-[239px] h-[280px] bg-s bg-center bg-cover'></div>
                            <div className='w-[239px] h-[162px] pt-[25px] pb-[25px] pl-[25px] pr-[25px] gap-[10px] flex flex-col'>
                                <h5 className='w-[131px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42]'>Graphic Design</h5>
                                <p className='w-[190px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373]'>English Department</p>
                                <div className='w-[108px] h-[34px] pt-[5px] pb-[5px] pr-[3px] pl-[3px] gap-[3px] flex flex-row'>
                        ...
                        <div className='w-[240px] h-[442px] bg-[#FFFFFF]'>
                            <div className='w-[239px] h-[280px] bg-s2 bg-center bg-cover'></div>
                            <div className='w-[239px] h-[162px] pt-[25px] pb-[25px] pl-[25px] pr-[25px] gap-[10px] flex flex-col'>
                                <h5 className='w-[131px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#252B42]'>Graphic Design</h5>
                                <p className='w-[190px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373]'>English Department</p>
                                <div className='w-[108px] h-[34px] pt-[5px] pb-[5px] pr-[3px] pl-[3px] gap-[3px] flex flex-row'>
