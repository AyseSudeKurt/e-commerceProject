...
function Pricing() {
    ...
    return (
        <div>
            <div className="w-full h-[280px] mt-[24px] pt-[50px] pb-[50px]">
                <div className="w-[427px] h-[180px] flex flex-col text-nowrap">
                    <h5 className="w-[71px] h-[24px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373] ml-[700px]">PRICING</h5>
                    <h2 className="w-[427px] h-[80px] font-montserrat font-bold text-6xl tracking-[0.2px] text-[#252B42] ml-[500px] mt-[40px]">Simple Pricing</h2>
                    <div className="w-[134px] h-[44px] pt-[10px] pb-[10px] gap-[15px] flex flex-row ml-[675px]">
                        <div className="w-[43px] h-[24px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#252B42]"><a href="/">Home</a></div>
                        <ChevronRight color="black" className="w-[20px] h-[20px]" />
                        <h6 className="w-[52px] h-[24px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#737373]">Pricing</h6>
                    </div>
                </div>
            </div>

            <div className="w-full h-[1162px] bg-[#FAFAFA]">
                <div className="w-[1050px] h-[1168px] ml-[195px] pt-[112px] pb-[112px] gap-[48px]">
                    <div className="w-[625px] h-[100px] gap-[10px]">
                        <h2 className="w-[144px] h-[50px] font-montserrat font-bold text-5xl tracking-[0.2px] text-[#252B42] ml-[450px]">Pricing</h2>
                        <div className="w-[469px] h-[40px] font-montserrat font-normal text-sm tracking-[0.2px] text-[#737373] text-center ml-[310px] mt-[20px]">Problems trying to resolve the conflict between<br></br>the two major realms of Classical physics: Newtonian mechanics </div>
                    </div>

                    <div className="w-[985px] h-[704px] mt-[100px]">
                        <div className="w-[327px] h-[664px] rounded-[10px] border-[1px] pt-[50px] pb-[50px] pl-[40px] pr-[40px] gap-[35px] bg-[#FFFFFF] border-[#23A6F0] ml-[55px]">
                            <h3 className="w-[64px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#252B42] ml-[90px]">FREE</h3>
                            <h5 className="w-[160px] h-[48px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373] text-center ml-[40px] mt-[40px]">Organize across all<br></br>apps by hand</h5>
                            <div className="w-[114px] h-[56px] gap-[10px] mt-[50px] ml-[60px]">
                                <h2 className="w-[28px] h-[50px] font-montserrat font-bold text-4xl tracking-[0.2px] text-[#23A6F0]">0</h2>
                                <div className="w-[76px] h-[56px] flex flex-col mt-[-60px] ml-[40px]">
                                    <h3 className="w-[16px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#23A6F0]">$</h3>
                                    <h5 className="w-[76px] h-[24px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#8EC2F2]">Per Month</h5>
                                </div>
                            </div>

                            <div className="w-[247px] h-[236px] gap-[15px] mt-[50px]">
                                <div className="w-[247px] h-[32px] gap-[10px] flex flex-row">
                                    <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#2DC071]" />
                                    <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#252B42] mt-2">Unlimited product updates</h6>
                                </div>

                                <div className="w-[247px] h-[32px] gap-[10px] flex flex-row text-nowrap">
                                    <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#2DC071] mt-2" />
                                    <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#252B42] mt-4">Unlimited product updates</h6>
                                </div>

                                <div className="w-[247px] h-[32px] gap-[10px] flex flex-row text-nowrap">
                                    <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#2DC071] mt-4" />
                                    <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#252B42] mt-6">Unlimited product updates</h6>
                                </div>

                                <div className="w-[247px] h-[32px] gap-[10px] flex flex-row text-nowrap">
                                    <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#BDBDBD] mt-6" />
                                    <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#252B42] mt-8">1GB  Cloud storage
                                    </h6>
                                </div>

                                <div className="w-[247px] h-[32px] gap-[10px] flex flex-row text-nowrap">
                                    <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#BDBDBD] mt-8" />
                                    <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#252B42] mt-10">Email and community<br></br>support
                                    </h6>
                                </div>
                            </div>

                            <div className="w-[246px] h-[52px] rounded-[5px] pt-[15px] pb-[15px] pr-[40px] pl-[40px] gap-[10px] bg-[#252B42]">
                                <div className=" font-montserrat font-bold text-sm tracking-[0.2px] text-[#FFFFFF] text-center flex ml-10">Try For Free</div>
                            </div>
                        </div>

                        <div className="w-[329px] h-[704px] bg-[#FAFAFA] ml-[380px] mt-[-700px]">
                            <div className="w-[327px] h-[704px] rounded-[10px] border-[1px] pt-[70px] pb-[70px] pl-[40px] pr-[40px] gap-[35px] text-[#252B42] bg-[#252B42]">
                                <h3 className="w-[64px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#FFFFFF] ml-[50px]">STANDARD</h3>
                                <h5 className="w-[160px] h-[48px] font-montserrat font-bold text-base tracking-[0.1px] text-[#FFFFFF] text-center ml-[40px] mt-[40px]">Organize across all<br></br>apps by hand</h5>
                                <div className="w-[114px] h-[56px] gap-[10px] mt-[50px] ml-[60px]">
                                    <h2 className="w-[28px] h-[50px] font-montserrat font-bold text-4xl tracking-[0.2px] text-[#23A6F0] ml-[-20px]">9.99</h2>
                                    <div className="w-[76px] h-[56px] flex flex-col mt-[-60px] ml-[70px]">
                                        <h3 className="w-[16px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#23A6F0]">$</h3>
                                        <h5 className="w-[76px] h-[24px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#8EC2F2]">Per Month</h5>
                                    </div>
                                </div>
                                ...
                                <div className="w-[247px] h-[236px] gap-[15px] mt-[50px]">
                                    <div className="w-[247px] h-[32px] gap-[10px] flex flex-row">
                                        <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#2DC071]" />
                                        <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#FFFFFF] mt-2">Unlimited product updates</h6>
                                    </div>

                                    <div className="w-[247px] h-[32px] gap-[10px] flex flex-row text-nowrap">
                                        <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#2DC071] mt-2" />
                                        <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#FFFFFF] mt-4">Unlimited product updates</h6>
                                    </div>

                                    <div className="w-[247px] h-[32px] gap-[10px] flex flex-row text-nowrap">
                                        <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#2DC071] mt-4" />
                                        <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#FFFFFF] mt-6">Unlimited product updates</h6>
                                    </div>

                                    <div className="w-[247px] h-[32px] gap-[10px] flex flex-row text-nowrap">
                                        <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#BDBDBD] mt-6" />
                                        <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#FFFFFF] mt-8">1GB  Cloud storage
                                        </h6>
                                    </div>

                                    <div className="w-[247px] h-[32px] gap-[10px] flex flex-row text-nowrap">
                                        <CircleCheck color="white" className="w-[32px] h-[32px] fill-[#BDBDBD] mt-8" />
                                        <h6 className="w-[205px] h-[30px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#FFFFFF] mt-10">Email and community<br></br>support
                                        </h6>
                                    </div>
                                </div>

                                <div className="w-[246px] h-[52px] rounded-[5px] pt-[15px] pb-[15px] pr-[40px] pl-[40px] gap-[10px] bg-[#23A6F0]">
                                    <div className=" font-montserrat font-bold text-sm tracking-[0.2px] text-[#FFFFFF] text-center flex ml-10">Try For Free</div>
                                </div>
                            </div>
                        </div>

                        <div className="w-[329px] h-[664px] bg-[#FAFAFA] ml-[707px] mt-[-675px]">
                            <div className="w-[327px] h-[664px] rounded-[10px] border-[1px] pt-[70px] border-[#23A6F0] pb-[70px] pl-[40px] pr-[40px] gap-[35px] text-[#252B42]">
                                <h3 className="w-[64px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#252B42]] ml-[50px]">PREMIUM</h3>
                                <h5 className="w-[160px] h-[48px] font-montserrat font-bold text-base tracking-[0.1px] text-[#737373] text-center ml-[40px] mt-[40px]">Organize across all<br></br>apps by hand</h5>
                                <div className="w-[114px] h-[56px] gap-[10px] mt-[50px] ml-[60px]">
                                    <h2 className="w-[28px] h-[50px] font-montserrat font-bold text-4xl tracking-[0.2px] text-[#23A6F0] ml-[-20px]">19.99</h2>
                                    <div className="w-[76px] h-[56px] flex flex-col mt-[-60px] ml-[80px]">
                                        <h3 className="w-[16px] h-[32px] font-montserrat font-bold text-2xl tracking-[0.1px] text-[#23A6F0]">$</h3>
                                        <h5 className="w-[76px] h-[24px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#8EC2F2]">Per Month</h5>
                                    </div>
                                </div>
            ...
            <div className="w-full h-[365px] bg-[#FAFAFA]">
                <h2 className="w-[385px] h-[30px] font-montserrat font-normal text-xl tracking-[0.2px] text-[#252B42] ml-[550px]">Trusted By Over 4000 Big Companies</h2>
                <div className="w-[1054px] h-[175px] pt-[50px] pb-[50px] gap-[30px] flex flex-row mt-4 ml-[280px]">
            ...
            <div className="w-full h-[1037px] bg-[#FFFFFF]">
                <div className="w-[1056px] h-[1037px] ml-[197px] pt-[80px] pb-[80px] gap-[50px]">
                    <div className="w-[1050px] h-[210px] pt-[45px] pb-[45px] flex flex-col">
                        <h2 className="w-[262px] h-[50px] font-montserrat font-bold text-4xl tracking-[0.2px] text-[#252B42] ml-[400px]">Pricing FAQs</h2>
                        <p className="w-[552px] h-[60px] font-montserrat font-normal text-xl tracking-[0.2px] text-[#737373] text-center ml-[250px]">Problems trying to resolve the conflict between<br></br>the two major realms of Classical physics</p>
                    </div>

                    <div className="w-[1056px] h-[537px] gap-[30px]">
                        <div className="w-[1056px] h-[159px] gap-[30px] flex flex-row">
                            <div className="w-[491px] h-[159px] rounded-[9px] p-[25px] flex flex-row text-nowrap">
                                <ChevronRight className="w-[15px] h-[15px] fill-[#23A6F0]" />
                                <h5 className="font-montserrat font-bold w-[309px] h-[24px] text-base tracking-[0.1px] text-[#252B42]">the quick fox jumps over the lazy dog</h5>
                                <h6 className="font-montserrat w-[408px] h-[80px] font-normal text-sm tracking-[0.2px] text-[#737373] ml-[-310px] mt-7">Met minim Mollie non desert Alamo est sit cliquey<br></br>
                                    dolor do met sent. RELIT official consequent door ENIM<br></br>
                                    RELIT Mollie. Excitation venial consequent sent<br></br>
                                    nostrum met.</h6>
                            </div>
                    ...
                    <div className="w-[1056px] h-[537px] gap-[30px] mt-[-350px]">
                        <div className="w-[1056px] h-[159px] gap-[30px] flex flex-row">
                            <div className="w-[491px] h-[159px] rounded-[9px] p-[25px] flex flex-row text-nowrap">
                                <ChevronRight className="w-[15px] h-[15px] fill-[#23A6F0]" />
                                <h5 className="font-montserrat font-bold w-[309px] h-[24px] text-base tracking-[0.1px] text-[#252B42]">the quick fox jumps over the lazy dog</h5>
                ...
                <div className="w-[552px] h-[30px] font-montserrat font-normal text-xl tracking-[0.2px] text-[#737373] mt-[-100px] ml-[480px]">Haven't got your answer? Contact our support</div>
            </div>

            <div className="w-full h-[582px] bg-[#FFFFFF]">
                <div className="w-[1050px] h-[602px] ml-[195px] pt-[160px] pb-[160px] gap-[96px]">
                    <div className="w-[607px] h-[282px] gap-[36px]">
                        <h2 className="font-montserrat font-bold w-[547px] h-[50px] text-4xl tracking-[0.2px] text-[#252B42] ml-[250px]">Start Your 14 Days Free Trial</h2>
                        <h6 className="w-[411px] h-[40px] font-montserrat font-normal text-sm tracking-[0.2px] text-[#737373] text-center ml-[320px] mt-4">Met minim Mollie non desert Alamo est sit cliquey dolor<br></br>
                            do met sent. RELIT official consequent.</h6>

                        <div className="w-[186px] h-[52px] gap-[10px] rounded-[5px] pt-[15px] pb-[15px] pr-[40px] pl-[40px] bg-[#23A6F0] ml-[430px] mt-4">
                            <h6 className="w-[106px] h-[22px] font-montserrat font-bold text-sm tracking-[0.2px] text-[#FFFFFF] text-nowrap mr-2">Try It Free Now</h6>
                        </div>


                        <div className="w-[242px] h-[50px] p-[10px] gap-[34px] flex flex-row ml-[400px] mt-10 fill-[#23A6F0]">
                            <svg role="img" className="w-[50px] h-[50px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Instagram</title><path d="M7.0301.084c-1.2768.0602-2.1487.264-2.911.5634-.7888.3075-1.4575.72-2.1228 1.3877-.6652.6677-1.075 1.3368-1.3802 2.127-.2954.7638-.4956 1.6365-.552 2.914-.0564 1.2775-.0689 1.6882-.0626 4.947.0062 3.2586.0206 3.6671.0825 4.9473.061 1.2765.264 2.1482.5635 2.9107.308.7889.72 1.4573 1.388 2.1228.6679.6655 1.3365 1.0743 2.1285 1.38.7632.295 1.6361.4961 2.9134.552 1.2773.056 1.6884.069 4.9462.0627 3.2578-.0062 3.668-.0207 4.9478-.0814 1.28-.0607 2.147-.2652 2.9098-.5633.7889-.3086 1.4578-.72 2.1228-1.3881.665-.6682 1.0745-1.3378 1.3795-2.1284.2957-.7632.4966-1.636.552-2.9124.056-1.2809.0692-1.6898.063-4.948-.0063-3.2583-.021-3.6668-.0817-4.9465-.0607-1.2797-.264-2.1487-.5633-2.9117-.3084-.7889-.72-1.4568-1.3876-2.1228C21.2982 1.33 20.628.9208 19.8378.6165 19.074.321 18.2017.1197 16.9244.0645 15.6471.0093 15.236-.005 11.977.0014 8.718.0076 8.31.0215 7.0301.0839m.1402 21.6932c-1.17-.0509-1.8053-.2453-2.2287-.408-.5606-.216-.96-.4771-1.3819-.895-.422-.4178-.6811-.8186-.9-1.378-.1644-.4234-.3624-1.058-.4171-2.228-.0595-1.2645-.072-1.6442-.079-4.848-.007-3.2037.0053-3.583.0607-4.848.05-1.169.2456-1.805.408-2.2282.216-.5613.4762-.96.895-1.3816.4188-.4217.8184-.6814 1.3783-.9003.423-.1651 1.0575-.3614 2.227-.4171 1.2655-.06 1.6447-.072 4.848-.079 3.2033-.007 3.5835.005 4.8495.0608 1.169.0508 1.8053.2445 2.228.408.5608.216.96.4754 1.3816.895.4217.4194.6816.8176.9005 1.3787.1653.4217.3617 1.056.4169 2.2263.0602 1.2655.0739 1.645.0796 4.848.0058 3.203-.0055 3.5834-.061 4.848-.051 1.17-.245 1.8055-.408 2.2294-.216.5604-.4763.96-.8954 1.3814-.419.4215-.8181.6811-1.3783.9-.4224.1649-1.0577.3617-2.2262.4174-1.2656.0595-1.6448.072-4.8493.079-3.2045.007-3.5825-.006-4.848-.0608M16.953 5.5864A1.44 1.44 0 1 0 18.39 4.144a1.44 1.44 0 0 0-1.437 1.4424M5.8385 12.012c.0067 3.4032 2.7706 6.1557 6.173 6.1493 3.4026-.0065 6.157-2.7701 6.1506-6.1733-.0065-3.4032-2.771-6.1565-6.174-6.1498-3.403.0067-6.156 2.771-6.1496 6.1738M8 12.0077a4 4 0 1 1 4.008 3.9921A3.9996 3.9996 0 0 1 8 12.0077" /></svg>
                            <svg role="img" className="w-[50px] h-[50px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Facebook</title><path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 26.805 26.805 0 0 0-.733-.009c-.707 0-1.259.096-1.675.309a1.686 1.686 0 0 0-.679.622c-.258.42-.374.995-.374 1.752v1.297h3.919l-.386 2.103-.287 1.564h-3.246v8.245C19.396 23.238 24 18.179 24 12.044c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.628 3.874 10.35 9.101 11.647Z" /></svg>
                            <svg role="img" className="w-[50px] h-[50px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>X</title><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" /></svg>
                        </div>
                    </div>
                </div>
            </div>
